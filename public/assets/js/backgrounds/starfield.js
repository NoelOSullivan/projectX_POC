...
(function ($, window, document, undefined) {
    ...
    Starfield.prototype = {
        ...
        projectXhandleOrientation: function (gyroData) {
            if (gyroData[1] !== null && gyroData[2] !== null) {
                var x = gyroData[2],
                    y = gyroData[1];
    ...
    Starfield.projectXhandleOrientation = Starfield.prototype.projectXhandleOrientation;
